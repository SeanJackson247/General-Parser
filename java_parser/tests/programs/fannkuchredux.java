...
Tue, 16 Mar 2021 18:44:23 GMT

MAKE:
mv fannkuchredux.java fannkuchredux.java
mv: 'fannkuchredux.java' and 'fannkuchredux.java' are the same file
make: [/home/dunham/all-benchmarksgame/2000-benchmarksgame/nanobench/makefiles/u64q.programs.Makefile:251: fannkuchredux.java_run] Error 1 (ignored)
/opt/src/jdk-16/bin/javac -d . -cp . fannkuchredux.java

1.56s to complete and log all make actions

COMMAND LINE:
/opt/src/jdk-16/bin/java  -cp . fannkuchredux 12
