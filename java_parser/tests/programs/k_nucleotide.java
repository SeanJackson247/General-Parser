...
Tue, 16 Mar 2021 18:47:23 GMT

MAKE:
mv knucleotide.java knucleotide.java
mv: 'knucleotide.java' and 'knucleotide.java' are the same file
make: [/home/dunham/all-benchmarksgame/2000-benchmarksgame/nanobench/makefiles/u64q.programs.Makefile:251: knucleotide.java_run] Error 1 (ignored)
/opt/src/jdk-16/bin/javac -d . -cp .:/opt/src/java-libs/fastutil-8.3.1.jar knucleotide.java

2.13s to complete and log all make actions

COMMAND LINE:
/opt/src/jdk-16/bin/java  -cp .:/opt/src/java-libs/fastutil-8.3.1.jar knucleotide 0 < knucleotide-input25000000.txt
